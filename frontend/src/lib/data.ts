...
import { Data, ProductInput, UserInput } from '../types'
  ...
  settings: [
    {
      ...
      site: {
        name: 'Emalii',
        description:
          'Emalii is a sample Ecommerce website built with Next.js, Tailwind CSS, and MongoDB.',
      ...
      availableCurrencies: [
        ...
        { name: 'Kenyan Shilling', code: 'KES', symbol: 'KSh', convertRate: 160 },
      ],
      defaultCurrency: 'USD',
