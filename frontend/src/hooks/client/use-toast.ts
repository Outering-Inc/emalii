...
const TOAST_LIMIT = 1
const TOAST_REMOVE_DELAY = 5000 // You can adjust duration as needed
...
interface State {
  toasts: (ToasterToast & { id: string; open: boolean })[]
}

type Action =
  | { type: "ADD_TOAST"; toast: ToasterToast & { id: string; open: boolean } }
